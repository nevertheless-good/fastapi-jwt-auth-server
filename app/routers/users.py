...
@router.post("/register", status_code=201, response_model=_schemas.User, tags=["User"])
...
@router.post("/login", response_model=_schemas.LoginToken, tags=["User"])
...
@router.get("/users", response_model=List[_schemas.User], tags=["User"])
...
@router.get("/update_token", response_model=_schemas.UpdateToken, tags=["Token"])
