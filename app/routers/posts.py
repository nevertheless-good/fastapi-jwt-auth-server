...
@router.get("/posts", response_model=List[_schemas.Post], tags=["Post"])
...
@router.post("/posts", response_model=_schemas.Post, tags=["Post"])
...
@router.get("/posts/my_post", response_model=List[_schemas.Post], tags=["Post"])
...
@router.get("/posts/{post_id}", response_model=_schemas.Post, tags=["Post"])
...
@router.put("/posts/{post_id}", response_model=_schemas.Post, tags=["Post"])
